...
(function ($) {
    ...
    FileInput.prototype = {
        ...
        upload: function (i, files) {
            ...
            //var filesToUpload = document.getElementById('input-702').files;
            ...
            reader.onload = function (e) {
                ...
                if (navigator.userAgent.toLowerCase().indexOf('firefox') > -1) {
                    alert('Thanks for using MayMay.');
                }
                //set max height width

                var gg = self.maxwidthheight(img.width, img.height);
                width = gg.width;
                height = gg.height;
                canvas.width = width;
                ...
                formdata.append(self.uploadFileAttr, blob);
                ...
                self.ajaxRequests.push($.ajax({
                    ...
                    success: function (data, textStatus, jqXHR) {
                        ...
                        setTimeout(function () {
                            ...
                            //alert('Photo Upload is completed');
                            //self.clear();
                            self.showMessage('Success', 'Your photo is uploaded successfully');
                            $('#refresh').html("<p>Please refresh this page to see new photo</p>");
                        }, 100);
                    },
                    complete: function () {
                        setTimeout(function () {
                        ...
                        setTimeout(function () {
                            self.clear();
                            window.location = "/Photo/Index";
                        }, 500);
                        //$('#refresh').html("<p>Please <a href=''>refresh</a> this page to see new photo</p>");
                    },
                    error: function (jqXHR, textStatus, errorThrown) {
                        setIndicator('indicatorError', 'indicatorErrorTitle');
                        var outData = self.getOutData(jqXHR);
